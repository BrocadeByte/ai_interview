...
""".strip()
    ...
    try:
        ...
        # Preserve any useful fields from the first response before filling gaps
        # from trusted score statistics.
        try:
...
def ensure_report_completeness(
    ...
    *,
    ...
    # The score is authoritative backend data, not a model-generated field.
